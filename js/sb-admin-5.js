const el = document.querySelector('#accordionSidebar');
el.classList.remove("toggled");

var valor = JSON.parse(sessionStorage.getItem('value'));
console.log('load valor', valor);

var responsiveflag = false;

if (sessionStorage.getItem('value') !== null && responsiveflag == true) {
  el.classList.remove("toggled");
  console.log(`si existe sessionStorage`);
} else {
